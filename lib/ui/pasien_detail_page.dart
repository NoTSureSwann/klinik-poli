          ...
          child: Column(
            ...
            children: [
              ...
              Align(
                  ...
                  child: Text(widget.pasien.namaPasien!,
                      style: TextStyle(
                          fontSize: 26 * ffem, fontWeight: FontWeight.bold))),
              Align(
                  alignment: Alignment.center,
                  child: Text("Nomor RM : ${widget.pasien.nomorRMPasien!}",
              ...
              _wText(
                  namaKetField: "Nomor RM Pasien",
                  namaField: widget.pasien.nomorRMPasien,
                  namaIcon: Icons.room_preferences_rounded,
                  warnaBG: Colors.lightBlueAccent),
              _wText(
                  namaKetField: "Nama Pasien",
                  namaField: widget.pasien.namaPasien,
                  namaIcon: Icons.people_alt,
                  warnaBG: Colors.green),
              _wText(
                  namaKetField: "Tanggal Lahir Pasien",
                  namaField: widget.pasien.tgllhrPasien,
                  namaIcon: Icons.date_range_outlined,
                  warnaBG: Colors.redAccent),
              _wText(
                  namaKetField: "Telp Pasien",
                  namaField: widget.pasien.telpPasien,
                  namaIcon: Icons.phone,
                  warnaBG: Colors.orange),
              _wText(
                  namaKetField: "Alamat Pasien",
                  namaField: widget.pasien.alamatPasien,
                  namaIcon: Icons.home,
