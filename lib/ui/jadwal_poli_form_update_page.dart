...
class JadwalPoliFormUpdatePage extends StatefulWidget {
  ...
  @override
  State<JadwalPoliFormUpdatePage> createState() =>
      _JadwalPoliFormUpdatePageState();
}
    ...
    return StreamBuilder<List<Poli>>(
        ...
        builder: (context, snapshot) {
          ...
          if (_selectedPoliId != null &&
              !list.any((p) => p.id == _selectedPoliId)) {
            final oldPoli = snapshot.data!.firstWhere(
                (p) => p.id == _selectedPoliId,
                orElse: () => Poli(id: _selectedPoliId, nm_poli: 'Unknown'));
    ...
    return FutureBuilder<List<Pegawai>>(
        ...
        builder: (context, snapshot) {
          ...
          if (_selectedDokterId != null &&
              !list.any((d) => d.id == _selectedDokterId)) {
